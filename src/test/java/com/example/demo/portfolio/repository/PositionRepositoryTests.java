...
class PositionRepositoryTests {
    ...
    void test_on_create_position() {
        ...
        positionEntity.setSymbolType(SymbolType.STOCK);
        //
    ...
    void test_on_count_of_type_after_create() {
        ...
        Assertions.assertTrue(positionEntity.getId() > 0);
        //
        int count = positionRepository.countBySymbolType(SymbolType.STOCK);
    ...
    void test_find_by_type_stock_records() {
        ...
        Assertions.assertTrue(positionEntity.getId() > 0);
        //
        List<PositionEntity> byType = positionRepository.findBySymbolType(SymbolType.STOCK);
