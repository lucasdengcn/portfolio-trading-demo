...
public class QuoteConsumerImpl extends AbstractQuoteConsumerImpl {
    ...
    public QuoteConsumerImpl(
            OptionPool optionPool, OptionPool putOptionPool, StockPool stockPool, PositionService positionService) {
        super(optionPool);
    ...
    private void triggerOptionsChanges(OptionPool optionPool, ByteString byteString, Quote stockQuote) {
        ...
        List<Integer> collect = options.stream()
                .parallel()
                .map(symbol -> updateCallOptionNav(symbol, byteString))
    ...
    private int updateCallOptionNav(String optionSymbol, ByteString byteString) {
        ...
        try {
            ...
            Quote build = optionQuote.toBuilder()
